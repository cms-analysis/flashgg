...
namespace flashgg {
    ...
    public:
        ...
        virtual bool isTag(std::string tagname ) const { return (false) ; } // never retrun true if DiphotonTagBase has not been tagged
        virtual std::string tagLabel() const  {return "" ;}
        private:
