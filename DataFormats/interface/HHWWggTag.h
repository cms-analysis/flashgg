...
namespace flashgg {
  ...
  public:
    ...
    HHWWggTag(edm::Ptr<flashgg::DiPhotonCandidate>, std::vector<double>);
    HHWWggTag(edm::Ptr<flashgg::DiPhotonCandidate>, edm::Ptr<flashgg::Electron>,std::vector<double>);
    HHWWggTag(edm::Ptr<flashgg::DiPhotonCandidate>, edm::Ptr<flashgg::Muon>,std::vector<double>);
