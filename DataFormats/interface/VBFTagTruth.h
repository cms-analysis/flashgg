...
namespace flashgg {
    ...
    public:
        ...
        float eta_Q1() const { return ( hasLeadingQuark() ? leadingQuark()->eta() : -1. ); }
        float phi_Q1() const { return ( hasLeadingQuark() ? leadingQuark()->phi() : -1. ); }
        float pt_Q2() const { return ( hasSubLeadingQuark() ? subLeadingQuark()->pt() : -1. ); }
        float eta_Q2() const { return ( hasSubLeadingQuark() ? subLeadingQuark()->eta() : -1. ); }
        float phi_Q2() const { return ( hasSubLeadingQuark() ? subLeadingQuark()->phi() : -1. ); }
