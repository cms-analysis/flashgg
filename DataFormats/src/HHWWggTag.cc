...
// }
  ...
  // HHWWggTag::HHWWggTag( std::vector<flashgg::DiPhotonCandidate> diphoVector, std::vector<flashgg::Electron> electronVector, 
...
/*
    ...
    for (unsigned int i = 0; i < GenParticlesVector_.size(); i++){
      ...
      for (unsigned int i = 0; i < quark_pdgids.size(); i++){
        ...
        // all gen_ quark objects in genparticles vector came from W bosons, as dictated by HHWWggTagProducer.cc 
