...
VBFDoubleHTag::VBFDoubleHTag() : DiPhotonTagBase::DiPhotonTagBase(), mva_(-2.) 
{  
}
...
VBFDoubleHTag::VBFDoubleHTag( edm::Ptr<flashgg::DiPhotonCandidate> diPho, edm::Ptr<flashgg::Jet> leadJet, edm::Ptr<flashgg::Jet> subleadJet, edm::Ptr<flashgg::Jet> VBFleadJet, edm::Ptr<flashgg::Jet> VBFsubleadJet )
    : mva_(-.2), MX_(0.),genMhh_(0.),genCosThetaStar_CS_(0.),leadJet_(leadJet), subleadJet_(subleadJet), VBFleadJet_(VBFleadJet), VBFsubleadJet_(VBFsubleadJet) 
...
float VBFDoubleHTag::getCosThetaStar_CS() const {
...
float VBFDoubleHTag::getCosThetaStar_CS_old(float ebeam) const {
...
std::vector<float> VBFDoubleHTag::CosThetaAngles() const {
...
float VBFDoubleHTag::HelicityCosTheta( TLorentzVector Booster, TLorentzVector Boosted) const
{
...
float VBFDoubleHTag::getPhoJetMinDr() const
{
...
float VBFDoubleHTag::getPhoJetOtherDr() const
{
...
float VBFDoubleHTag::getSigmaMDecorr() const
{
...
float VBFDoubleHTag::getSigmaMOverMJets() const
{
