...
namespace flashgg {
    VHhadMVAResult::VHhadMVAResult () :
        ...
        vhHadMvaResult_value     ( -9999. ),
        vhHadMvaResult_value_bdt ( -9999. ),
        vhHadMvaResult_value_bdtg( -9999. )
    {}
    
    VHhadMVAResult::VHhadMVAResult( edm::Ptr<VHhadMVAResult> x )
    {
        leadJet          = x->leadJet;
        ...
        // VHhad MVA results different methods
        // need to be remove at some point ?
        vhHadMvaResult_value      = x->vhHadMvaResult_value;
        vhHadMvaResult_value_bdt  = x->vhHadMvaResult_value_bdt;
        vhHadMvaResult_value_bdtg = x->vhHadMvaResult_value_bdtg;
    }
}
// Local Variables:
// mode:c++
