...
cd $CMSSW_BASE/src/flashgg/MetaData/work
./prepareCrabJobs.py -C RunIIFall15DR76-1_3_0-25ns -U 5 -L 25 -s campaigns/RunIIFall15DR76-1_3_0-25ns.json -V 1_3_0 -p ${CMSSW_BASE}/src/flashgg/MicroAOD/test/microAODstd.py  --lumiMask ${PWD}/jsons/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_v2.txt
cd RunIIFall15DR76-1_3_0-25ns
...
#### 1_2_0 SingleElectron (2015D) + TTH backgrounds

Should be 1_1_0 compatible

```
cd $CMSSW_BASE/src/flashgg/MetaData/work
./prepareCrabJobs.py -C RunIISpring15-SingleEle2015D-TTG-TTJ-TGJ-WG-ZG-1_2_0-25ns -U 5 -L 25 -s campaigns/RunIISpring15-SingleEle2015D-TTG-TTJ-TGJ-WG-ZG-1_2_0-25ns.json -V 1_2_0 -p ${CMSSW_BASE}/src/flashgg/MicroAOD/test/microAODstd.py --lumiMask $PWD/jsons/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_v2.txt
cd RunIISpring15-SingleEle2015D-TTG-TTJ-TGJ-WG-ZG-1_2_0-25ns
python $CMSSW_BASE/src/flashgg/MetaData/scripts/stupid_fix.py
mkdir orig ; mv crabConfig_*orig*.py orig
echo crabConfig_*.py | xargs -n 1 crab sub
...
Rerun of the missing parts...

```
cd $CMSSW_BASE/src/flashgg/MetaData/work
./prepareCrabJobs.py -C RunIISpring15-ReReco74X-Rerun-1_1_0-25ns -U 5 -L 25 -s campaigns/RunIISpring15-ReReco74X-Rerun-1_1_0-25ns.json -V 1_2_0 -p ${CMSSW_BASE}/src/flashgg/MicroAOD/test/microAODstd.py --lumiMask ${PWD}/jsons/DoubleEG_74x_therest.json
cd RunIISpring15-ReReco74X-Rerun-1_1_0-25ns
echo crabConfig_*.py | xargs -n 1 crab sub
```
