...
For this you can add the list of crab subfolder names in the list named `badFolders`. 
...
This list is defined in [MetaData/python/samples_utils.py](https://github.com/atishelmanch/flashgg/blob/a6cf18682a9e96a86137a83af23614c713621ec0/MetaData/python/samples_utils.py#L375-L377)
