...
# rm $CMSSW_BASE/external/slc6_amd64_gcc530/data/RecoEgamma/ElectronIdentification/data/*.xml
# rm $CMSSW_BASE/external/slc6_amd64_gcc530/data/RecoEgamma/ElectronIdentification/data/PHYS14/*.xml
# rm $CMSSW_BASE/external/slc6_amd64_gcc530/data/RecoEgamma/ElectronIdentification/data/Spring15/*.xml
# rm $CMSSW_BASE/external/slc6_amd64_gcc530/data/RecoEgamma/PhotonIdentification/data/PHYS14/*.xml
# rm $CMSSW_BASE/external/slc6_amd64_gcc530/data/RecoEgamma/PhotonIdentification/data/Spring15/*.xml
