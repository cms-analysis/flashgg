...
#../../../Fall17_17Nov2017BCDEF_V6_DATA.db  ../../../Fall17_17Nov2017_V6_MC.db  ../../../QGL_cmssw8020_v2.db
    ...
    for sample in samples:
        ...
        if len(jobname) > 97:
            jobname = jobname.replace("RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14","PU2017_94Xv14")
        if len(jobname) > 97:
            jobname = jobname.replace("RunIIFall17MiniAODv2-PU2017_12Apr2018_1core_94X_mc2017_realistic_v14","1core_94Xv1")
        if len(jobname) > 97:
            print orig_jobname
