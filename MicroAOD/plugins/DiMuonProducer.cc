...
namespace flashgg {
    ...
    void DiMuonProducer::produce( Event &evt, const EventSetup & )
    {
        ...
        const std::vector<edm::Ptr<flashgg::Muon> > &muonPointers = muons->ptrs();
