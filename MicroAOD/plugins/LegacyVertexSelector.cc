...
namespace flashgg {
    ...
    public:
        ...
        void getInfoFromLastSelection( std::vector<float> & ) override;
        void getInfoFromLastSelectionForVtxIdx( std::vector<float> &, unsigned int ) override; 
        ...
        VertexSelectorBase( iConfig )
    {
        ...
        era = iConfig.getParameter<unsigned int>( "era" );
        if(era == 2017) {
            vertexIdMVAweightfile_ = iConfig.getParameter<edm::FileInPath>( "vertexIdMVAweightfile_17" );
            vertexProbMVAweightfile_ = iConfig.getParameter<edm::FileInPath>( "vertexProbMVAweightfile_17" );
            sigma1Pix             = iConfig.getParameter<double>( "sigma1Pix_17" );
            sigma1Tib             = iConfig.getParameter<double>( "sigma1Tib_17" );
            sigma1Tob             = iConfig.getParameter<double>( "sigma1Tob_17" );
            sigma1PixFwd          = iConfig.getParameter<double>( "sigma1PixFwd_17" );
            sigma1Tid             = iConfig.getParameter<double>( "sigma1Tid_17" );
            sigma1Tec             = iConfig.getParameter<double>( "sigma1Tec_17" );
            sigma2Pix             = iConfig.getParameter<double>( "sigma2Pix_17" );
            sigma2Tib             = iConfig.getParameter<double>( "sigma2Tib_17" );
            sigma2Tob             = iConfig.getParameter<double>( "sigma2Tob_17" );
            sigma2PixFwd          = iConfig.getParameter<double>( "sigma2PixFwd_17" );
            sigma2Tid             = iConfig.getParameter<double>( "sigma2Tid_17" );
            sigma2Tec             = iConfig.getParameter<double>( "sigma2Tec_17" );
            singlelegsigma1Pix    = iConfig.getParameter<double>( "singlelegsigma1Pix_17" );
            singlelegsigma1Tib    = iConfig.getParameter<double>( "singlelegsigma1Tib_17" );
            singlelegsigma1Tob    = iConfig.getParameter<double>( "singlelegsigma1Tob_17" );
            singlelegsigma1PixFwd = iConfig.getParameter<double>( "singlelegsigma1PixFwd_17" );
            singlelegsigma1Tid    = iConfig.getParameter<double>( "singlelegsigma1Tid_17" );
            singlelegsigma1Tec    = iConfig.getParameter<double>( "singlelegsigma1Tec_17" );
            singlelegsigma2Pix    = iConfig.getParameter<double>( "singlelegsigma2Pix_17" );
            singlelegsigma2Tib    = iConfig.getParameter<double>( "singlelegsigma2Tib_17" );
            singlelegsigma2Tob    = iConfig.getParameter<double>( "singlelegsigma2Tob_17" );
            singlelegsigma2PixFwd = iConfig.getParameter<double>( "singlelegsigma2PixFwd_17" );
            singlelegsigma2Tid    = iConfig.getParameter<double>( "singlelegsigma2Tid_17" );
            singlelegsigma2Tec    = iConfig.getParameter<double>( "singlelegsigma2Tec_17" );
        } else if (era == 2016) {   
            vertexIdMVAweightfile_ = iConfig.getParameter<edm::FileInPath>( "vertexIdMVAweightfile_16" );
            vertexProbMVAweightfile_ = iConfig.getParameter<edm::FileInPath>( "vertexProbMVAweightfile_16" );
            sigma1Pix             = iConfig.getParameter<double>( "sigma1Pix_16" );
            sigma1Tib             = iConfig.getParameter<double>( "sigma1Tib_16" );
            sigma1Tob             = iConfig.getParameter<double>( "sigma1Tob_16" );
            sigma1PixFwd          = iConfig.getParameter<double>( "sigma1PixFwd_16" );
            sigma1Tid             = iConfig.getParameter<double>( "sigma1Tid_16" );
            sigma1Tec             = iConfig.getParameter<double>( "sigma1Tec_16" );
            sigma2Pix             = iConfig.getParameter<double>( "sigma2Pix_16" );
            sigma2Tib             = iConfig.getParameter<double>( "sigma2Tib_16" );
            sigma2Tob             = iConfig.getParameter<double>( "sigma2Tob_16" );
            sigma2PixFwd          = iConfig.getParameter<double>( "sigma2PixFwd_16" );
            sigma2Tid             = iConfig.getParameter<double>( "sigma2Tid_16" );
            sigma2Tec             = iConfig.getParameter<double>( "sigma2Tec_16" );
            singlelegsigma1Pix    = iConfig.getParameter<double>( "singlelegsigma1Pix_16" );
            singlelegsigma1Tib    = iConfig.getParameter<double>( "singlelegsigma1Tib_16" );
            singlelegsigma1Tob    = iConfig.getParameter<double>( "singlelegsigma1Tob_16" );
            singlelegsigma1PixFwd = iConfig.getParameter<double>( "singlelegsigma1PixFwd_16" );
            singlelegsigma1Tid    = iConfig.getParameter<double>( "singlelegsigma1Tid_16" );
            singlelegsigma1Tec    = iConfig.getParameter<double>( "singlelegsigma1Tec_16" );
            singlelegsigma2Pix    = iConfig.getParameter<double>( "singlelegsigma2Pix_16" );
            singlelegsigma2Tib    = iConfig.getParameter<double>( "singlelegsigma2Tib_16" );
            singlelegsigma2Tob    = iConfig.getParameter<double>( "singlelegsigma2Tob_16" );
            singlelegsigma2PixFwd = iConfig.getParameter<double>( "singlelegsigma2PixFwd_16" );
            singlelegsigma2Tid    = iConfig.getParameter<double>( "singlelegsigma2Tid_16" );
            singlelegsigma2Tec    = iConfig.getParameter<double>( "singlelegsigma2Tec_16" );
        }
    ...
    void LegacyVertexSelector::getInfoFromLastSelection( std::vector<float> &info )
    {
        info.push_back( vtxprobmva_ );
        info.push_back( logsumpt2selected_ );
        info.push_back( ptbalselected_ );
        info.push_back( ptasymselected_ );
        info.push_back( nVert_ );
        info.push_back( MVA0_ );
        info.push_back( MVA1_ );
        info.push_back( MVA2_ );
        info.push_back( dZ1_ );
        info.push_back( dZ2_ );
    }

    void LegacyVertexSelector::getInfoFromLastSelectionForVtxIdx( std::vector<float> &info, unsigned int iVertex )
    {
        if( iVertex < vmva_value_.size() ) {
            info.push_back( vmva_value_[iVertex] );
            info.push_back( vlogsumpt2_[iVertex] );
            info.push_back( vptbal_[iVertex] );
            info.push_back( vptasym_[iVertex] );            
        }
    }
