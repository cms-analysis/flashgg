...
namespace flashgg {
  ...
  public:
    ...
    void setVertices( edm::PtrVector<reco::Vertex> vval ) { Vertices_ = vval; }
    ...
    edm::Ptr<reco::Vertex> getVertices(unsigned int iVtx) const {return iVtx<Vertices_.size()?Vertices_[iVtx]:vertex_; } 
