...
from flashgg.MicroAODProducers.flashggMuons_cfi import flashggMuons
...
flashggMicroAODSequence = cms.Sequence((flashggVertexMapUnique+flashggVertexMapNonUnique+flashggElectrons+flashggMuons
#flashggMicroAODSequence = cms.Sequence((flashggVertexMapUnique+flashggVertexMapNonUnique+flashggElectrons
