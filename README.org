...
** Setup
   ...
   - **N.B.** These are the instructions for the STXS workflow, which is under development and not yet fully merged into the default flashgg

   Supported releases:
   - 10_5_0
   - 10_6_1_patch2 required for this stage 1.1 branch
   ...
   cd flashgg
   git remote add edjtscott git@github.com:edjtscott/flashgg.git
   git fetch edjtscott
   git checkout edjtscott/dev_legacy_runII_STXSanalysis
