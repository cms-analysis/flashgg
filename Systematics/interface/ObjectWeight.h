...
namespace flashgg {
    ...
    public:
        ...
        ObjectWeight( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv=0);
    ...
    template<typename flashgg_object, typename param_var>
    ObjectWeight<flashgg_object, param_var>::ObjectWeight( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv ) : 
        ObjectSystMethodBinnedByFunctor<flashgg_object, param_var>( conf, gv ),
