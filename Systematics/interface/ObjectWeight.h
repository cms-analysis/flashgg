...
namespace flashgg {
    ...
    public:
        ...
        ObjectWeight( const edm::ParameterSet &conf, edm::ConsumesCollector && iC );
    ...
    template<typename flashgg_object, typename param_var>
    ObjectWeight<flashgg_object, param_var>::ObjectWeight( const edm::ParameterSet &conf, edm::ConsumesCollector && iC ) : 
