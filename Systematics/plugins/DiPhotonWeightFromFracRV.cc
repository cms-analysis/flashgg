...
namespace flashgg {
    ...
    public:
        ...
        DiPhotonWeightFromFracRV( const edm::ParameterSet &conf, const GlobalVariablesComputer * gv);
    ...
    DiPhotonWeightFromFracRV::DiPhotonWeightFromFracRV( const edm::ParameterSet &conf, const GlobalVariablesComputer * gv ) :
