...
namespace flashgg {
    ...
    public:
        ...
        DiPhotonWeightFromFracRV( const edm::ParameterSet &conf, edm::ConsumesCollector && iC );
    ...
    DiPhotonWeightFromFracRV::DiPhotonWeightFromFracRV( const edm::ParameterSet &conf, edm::ConsumesCollector && iC ) :
