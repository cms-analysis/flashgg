...
namespace flashgg {
    ...
    public:
        ...
        JetSmearConstant( const edm::ParameterSet &conf, const GlobalVariablesComputer * gv );
    ...
    JetSmearConstant::JetSmearConstant( const edm::ParameterSet &conf, const GlobalVariablesComputer * gv  ) :
