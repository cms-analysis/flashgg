...
namespace flashgg {
    ...
    public:
        ...
        PhotonMvaShift( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv );
    ...
    PhotonMvaShift::PhotonMvaShift( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv ) :
