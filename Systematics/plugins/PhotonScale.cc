...
namespace flashgg {
    ...
    public:
        ...
        PhotonScale( const edm::ParameterSet &conf, const GlobalVariablesComputer * gv );
    ...
    PhotonScale::PhotonScale( const edm::ParameterSet &conf, const GlobalVariablesComputer * gv ) :
