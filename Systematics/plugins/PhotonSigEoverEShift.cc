...
namespace flashgg {
    ...
    public:
        ...
        PhotonSigEOverEShift( const edm::ParameterSet &conf, edm::ConsumesCollector && iC );
    ...
    PhotonSigEOverEShift::PhotonSigEOverEShift( const edm::ParameterSet &conf, edm::ConsumesCollector && iC ) :
