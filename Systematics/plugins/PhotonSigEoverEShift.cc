...
namespace flashgg {
    ...
    public:
        ...
        PhotonSigEOverEShift( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv );
    ...
    PhotonSigEOverEShift::PhotonSigEOverEShift( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv ) :
