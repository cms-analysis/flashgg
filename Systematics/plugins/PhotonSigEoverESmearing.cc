...
namespace flashgg {
    ...
    public:
        ...
        PhotonSigEoverESmearing( const edm::ParameterSet &conf, edm::ConsumesCollector && iC );
    ...
    PhotonSigEoverESmearing::PhotonSigEoverESmearing( const edm::ParameterSet &conf, edm::ConsumesCollector && iC ) :
