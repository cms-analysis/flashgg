...
namespace flashgg {
    ...
    public:
        ...
        PhotonSmearConstant( const edm::ParameterSet &conf, edm::ConsumesCollector && iC );
    ...
    PhotonSmearConstant::PhotonSmearConstant( const edm::ParameterSet &conf, edm::ConsumesCollector && iC ) :
