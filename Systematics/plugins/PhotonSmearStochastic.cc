...
namespace flashgg {
    ...
    public:
        ...
        PhotonSmearStochastic( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv );
    ...
    PhotonSmearStochastic::PhotonSmearStochastic( const edm::ParameterSet &conf, const GlobalVariablesComputer *gv ) :
