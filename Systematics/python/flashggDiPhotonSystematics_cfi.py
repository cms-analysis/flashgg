...
leadTriggerScaleBins = cms.PSet(
    ...
    bins = cms.VPSet(
        ...
        cms.PSet(lowBounds = cms.vdouble(0,0,30), upBounds = cms.vdouble(0.94,1.5,33.33), values = cms.vdouble(0.956219), uncertainties = cms.vdouble(0.00277459,0.00266194)),
        cms.PSet(lowBounds = cms.vdouble(0,0,33.33), upBounds = cms.vdouble(0.94,1.5,35), values = cms.vdouble(0.995639), uncertainties = cms.vdouble(0.00111805,0.00436078)),
        cms.PSet(lowBounds = cms.vdouble(0,0,35), upBounds = cms.vdouble(0.94,1.5,40), values = cms.vdouble(0.997032), uncertainties = cms.vdouble(0.000421703,0.000385255)),
        cms.PSet(lowBounds = cms.vdouble(0,0,40), upBounds = cms.vdouble(0.94,1.5,45), values = cms.vdouble(0.998391), uncertainties = cms.vdouble(0.000257508,0.000257508)),
        cms.PSet(lowBounds = cms.vdouble(0,0,45), upBounds = cms.vdouble(0.94,1.5,50), values = cms.vdouble(0.998741), uncertainties = cms.vdouble(0.000302614,0.000261119)),
        cms.PSet(lowBounds = cms.vdouble(0,0,50), upBounds = cms.vdouble(0.94,1.5,60), values = cms.vdouble(0.999679), uncertainties = cms.vdouble(0.000250081,0.000321458)),
        cms.PSet(lowBounds = cms.vdouble(0,0,60), upBounds = cms.vdouble(0.94,1.5,70), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00071693,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,70), upBounds = cms.vdouble(0.94,1.5,90), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00145938,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,90), upBounds = cms.vdouble(0.94,1.5,120), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0032519,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,120), upBounds = cms.vdouble(0.94,1.5,150), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00797462,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,150), upBounds = cms.vdouble(0.94,1.5,250), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00930901,0)),
        
        cms.PSet(lowBounds = cms.vdouble(0.94,0,0), upBounds = cms.vdouble(999,1.5,30), values = cms.vdouble(0.0), uncertainties = cms.vdouble(0.00673403,0.00846658)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,30), upBounds = cms.vdouble(999,1.5,33.33), values = cms.vdouble(0.632284), uncertainties = cms.vdouble(0.0204243,0.0168544)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,33.33), upBounds = cms.vdouble(999,1.5,35), values = cms.vdouble(0.925289), uncertainties = cms.vdouble(0.00320364,0.00312216)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,35), upBounds = cms.vdouble(999,1.5,40), values = cms.vdouble(0.990161), uncertainties = cms.vdouble(0.000728186,0.000705861)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,40), upBounds = cms.vdouble(999,1.5,45), values = cms.vdouble(0.9956), uncertainties = cms.vdouble(0.000386337,0.000386337)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,45), upBounds = cms.vdouble(999,1.5,50), values = cms.vdouble(0.996948), uncertainties = cms.vdouble(0.000442592,0.000403434)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,50), upBounds = cms.vdouble(999,1.5,60), values = cms.vdouble(0.99712), uncertainties = cms.vdouble(0.0005534,0.0005534)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,60), upBounds = cms.vdouble(999,1.5,70), values = cms.vdouble(0.996314), uncertainties = cms.vdouble(0.00128866,0.00104443)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,70), upBounds = cms.vdouble(999,1.5,90), values = cms.vdouble(0.997495), uncertainties = cms.vdouble(0.0014445,0.0014445)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,90), upBounds = cms.vdouble(999,1.5,120), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00334379,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,120), upBounds = cms.vdouble(999,1.5,150), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0100245,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,150), upBounds = cms.vdouble(999,1.5,250), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0141262,0)),
        
        cms.PSet(lowBounds = cms.vdouble(0,0,0), upBounds = cms.vdouble(0.94,1.5,30), values = cms.vdouble(0.0), uncertainties = cms.vdouble(0.0156345,0.0402519)),
        cms.PSet(lowBounds = cms.vdouble(0,0,30), upBounds = cms.vdouble(0.94,1.5,33.33), values = cms.vdouble(0.994933), uncertainties = cms.vdouble(0.00260634,0.00506682)),
        cms.PSet(lowBounds = cms.vdouble(0,0,33.33), upBounds = cms.vdouble(0.94,1.5,35), values = cms.vdouble(0.998649), uncertainties = cms.vdouble(0,0.000515804)),
        cms.PSet(lowBounds = cms.vdouble(0,0,35), upBounds = cms.vdouble(0.94,1.5,40), values = cms.vdouble(0.998545), uncertainties = cms.vdouble(0.000749831,0.000557251)),
        cms.PSet(lowBounds = cms.vdouble(0,0,40), upBounds = cms.vdouble(0.94,1.5,45), values = cms.vdouble(0.996542), uncertainties = cms.vdouble(0.00140904,0.00140904)),
        cms.PSet(lowBounds = cms.vdouble(0,0,45), upBounds = cms.vdouble(0.94,1.5,50), values = cms.vdouble(0.995326), uncertainties = cms.vdouble(0.00240807,0.00178999)),
        cms.PSet(lowBounds = cms.vdouble(0,0,50), upBounds = cms.vdouble(0.94,1.5,60), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00730364,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,60), upBounds = cms.vdouble(0.94,1.5,70), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0114313,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,70), upBounds = cms.vdouble(0.94,1.5,90), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0239662,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,90), upBounds = cms.vdouble(0.94,1.5,120), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0521317,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,120), upBounds = cms.vdouble(0.94,1.5,150), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0806517,0)),
        
        cms.PSet(lowBounds = cms.vdouble(0.94,0,0.0), upBounds = cms.vdouble(999,1.5,30), values = cms.vdouble(0.0), uncertainties = cms.vdouble(0.0117054,0.0123497)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,30), upBounds = cms.vdouble(999,1.5,33.33), values = cms.vdouble(0.792515), uncertainties = cms.vdouble(0.00907658,0.0089043)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,33.33), upBounds = cms.vdouble(999,1.5,35), values = cms.vdouble(0.964653), uncertainties = cms.vdouble(0.00536436,0.00490242)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,35), upBounds = cms.vdouble(999,1.5,40), values = cms.vdouble(0.97578), uncertainties = cms.vdouble(0.0023594,0.00222999)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,40), upBounds = cms.vdouble(999,1.5,45), values = cms.vdouble(0.974525), uncertainties = cms.vdouble(0.0025812,0.00242506)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,45), upBounds = cms.vdouble(999,1.5,50), values = cms.vdouble(0.982105), uncertainties = cms.vdouble(0.00321228,0.00287424)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,50), upBounds = cms.vdouble(999,1.5,60), values = cms.vdouble(0.987108), uncertainties = cms.vdouble(0.00361022,0.00304097)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,60), upBounds = cms.vdouble(999,1.5,70), values = cms.vdouble(0.971181), uncertainties = cms.vdouble(0.0113546,0.00899819)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,70), upBounds = cms.vdouble(999,1.5,90), values = cms.vdouble(0.984453), uncertainties = cms.vdouble(0,0.0073096)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,90), upBounds = cms.vdouble(999,1.5,120), values = cms.vdouble(0.987206), uncertainties = cms.vdouble(0.0126855,0.0126855)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,120), upBounds = cms.vdouble(999,1.5,150), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0808998,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,150), upBounds = cms.vdouble(999,1.5,250), values = cms.vdouble(1), uncertainties = cms.vdouble(0.113917,0)),
        )
    )
...
subleadTriggerScaleBins = cms.PSet(
    ...
    bins = cms.VPSet(
        ...
        cms.PSet(lowBounds = cms.vdouble(0.94,0,150), upBounds = cms.vdouble(999,1.5,250), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00938149,0)),
        ...
        cms.PSet(lowBounds = cms.vdouble(0,0,150), upBounds = cms.vdouble(0.94,1.5,250), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0154601,0)),
        
        cms.PSet(lowBounds = cms.vdouble(0.94,0,20), upBounds = cms.vdouble(999,1.5,22.5), values = cms.vdouble(0.999999), uncertainties = cms.vdouble(0.00181133,0.00181133)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,22.5), upBounds = cms.vdouble(999,1.5,25), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0087868,6.95923e-08)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,25), upBounds = cms.vdouble(999,1.5,27.5), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00280262,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,27.5), upBounds = cms.vdouble(999,1.5,30), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00116971,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,30), upBounds = cms.vdouble(999,1.5,33.33), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00107293,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,33.33), upBounds = cms.vdouble(999,1.5,35), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00190493,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,35), upBounds = cms.vdouble(999,1.5,40), values = cms.vdouble(0.999446), uncertainties = cms.vdouble(0.000489574,0.000553792)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,40), upBounds = cms.vdouble(999,1.5,45), values = cms.vdouble(0.999701), uncertainties = cms.vdouble(0.000298843,0.000298843)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,45), upBounds = cms.vdouble(999,1.5,50), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00114621,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,50), upBounds = cms.vdouble(999,1.5,60), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00188188,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,60), upBounds = cms.vdouble(999,1.5,70), values = cms.vdouble(1), uncertainties = cms.vdouble(0.00829012,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,70), upBounds = cms.vdouble(999,1.5,90), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0108213,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,90), upBounds = cms.vdouble(999,1.5,120), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0243501,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,120), upBounds = cms.vdouble(999,1.5,150), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0521317,0)),
        cms.PSet(lowBounds = cms.vdouble(0.94,0,150), upBounds = cms.vdouble(999,1.5,250), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0843269,0)),
        
        cms.PSet(lowBounds = cms.vdouble(0,0,20), upBounds = cms.vdouble(0.94,1.5,22.5), values = cms.vdouble(0.937199), uncertainties = cms.vdouble(0.0195123,0.0628008)),
        cms.PSet(lowBounds = cms.vdouble(0,0,22.5), upBounds = cms.vdouble(0.94,1.5,25), values = cms.vdouble(0.960077), uncertainties = cms.vdouble(0.00907036,0.0399231)),
        cms.PSet(lowBounds = cms.vdouble(0,0,25), upBounds = cms.vdouble(0.94,1.5,27.5), values = cms.vdouble(0.963207), uncertainties = cms.vdouble(0.0119252,0.0367926)),
        cms.PSet(lowBounds = cms.vdouble(0,0,27.5), upBounds = cms.vdouble(0.94,1.5,30), values = cms.vdouble(0.968227), uncertainties = cms.vdouble(0.00800151,0.00614946)),
        cms.PSet(lowBounds = cms.vdouble(0,0,30), upBounds = cms.vdouble(0.94,1.5,33.33), values = cms.vdouble(0.978704), uncertainties = cms.vdouble(0.00341527,0.00349418)),
        cms.PSet(lowBounds = cms.vdouble(0,0,33.33), upBounds = cms.vdouble(0.94,1.5,35), values = cms.vdouble(0.971527), uncertainties = cms.vdouble(0.00497568,0.00446629)),
        cms.PSet(lowBounds = cms.vdouble(0,0,35), upBounds = cms.vdouble(0.94,1.5,40), values = cms.vdouble(0.977258), uncertainties = cms.vdouble(0.00228581,0.00214555)),
        cms.PSet(lowBounds = cms.vdouble(0,0,40), upBounds = cms.vdouble(0.94,1.5,45), values = cms.vdouble(0.974762), uncertainties = cms.vdouble(0.00259899,0.00243617)),
        cms.PSet(lowBounds = cms.vdouble(0,0,45), upBounds = cms.vdouble(0.94,1.5,50), values = cms.vdouble(0.980811), uncertainties = cms.vdouble(0.00321191,0.00321191)),
        cms.PSet(lowBounds = cms.vdouble(0,0,50), upBounds = cms.vdouble(0.94,1.5,60), values = cms.vdouble(0.990012), uncertainties = cms.vdouble(0,0.00295888)),
        cms.PSet(lowBounds = cms.vdouble(0,0,60), upBounds = cms.vdouble(0.94,1.5,70), values = cms.vdouble(0.971907), uncertainties = cms.vdouble(0.019931,0.0132091)),
        cms.PSet(lowBounds = cms.vdouble(0,0,70), upBounds = cms.vdouble(0.94,1.5,90), values = cms.vdouble(0.9881), uncertainties = cms.vdouble(0.00835685,0.00835685)),
        cms.PSet(lowBounds = cms.vdouble(0,0,90), upBounds = cms.vdouble(0.94,1.5,120), values = cms.vdouble(0.986682), uncertainties = cms.vdouble(0.0177913,0.00928659)),
        cms.PSet(lowBounds = cms.vdouble(0,0,120), upBounds = cms.vdouble(0.94,1.5,150), values = cms.vdouble(1), uncertainties = cms.vdouble(0.0848572,0)),
        cms.PSet(lowBounds = cms.vdouble(0,0,150), upBounds = cms.vdouble(0.94,1.5,250), values = cms.vdouble(1), uncertainties = cms.vdouble(0.121587,0))
        )
    )
...
flashggDiPhotonSystematics = cms.EDProducer('FlashggDiPhotonSystematicProducer',
		...
		SystMethods = cms.VPSet(
                                        ...
                                        cms.PSet( PhotonMethodName = cms.string("FlashggPhotonWeight"),
                                                  MethodName = cms.string("FlashggDiPhotonFromPhoton"),
                                                  Label = cms.string("TriggerWeightLead"),
                                                  NSigmas = cms.vint32(-1,1),
                                                  OverallRange = cms.string("1"),
                                        ...
                                        cms.PSet( PhotonMethodName = cms.string("FlashggPhotonWeight"),
                                                  MethodName = cms.string("FlashggDiPhotonFromPhoton"),
                                                  Label = cms.string("TriggerWeightSubLead"),
                                                  NSigmas = cms.vint32(-1,1),
                                                  OverallRange = cms.string("1"),
                                                  BinList = subleadTriggerScaleBins,
                                                  Debug = cms.untracked.bool(False)
                                                  ),
                                        cms.PSet( PhotonMethodName = cms.string("FlashggPhotonWeight"),
                                                  MethodName = cms.string("FlashggDiPhotonFromPhoton"),
