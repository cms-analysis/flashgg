...
leadTriggerScaleBins = cms.PSet(
    ...
    bins = cms.VPSet(
        ...
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,0), upBounds = cms.vdouble(0.85,3.0,33.3333), values = cms.vdouble(0.662814), uncertainties = cms.vdouble(0.157045,0.157045)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,33.3333), upBounds = cms.vdouble(0.85,3.0,35), values = cms.vdouble(0.81578), uncertainties = cms.vdouble(0.084438,0.084438)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,35), upBounds = cms.vdouble(0.85,3.0,40), values = cms.vdouble(0.83025), uncertainties = cms.vdouble(0.0735095,0.0735095)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,40), upBounds = cms.vdouble(0.85,3.0,45), values = cms.vdouble(0.845993), uncertainties = cms.vdouble(0.0675948,0.0675948)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,45), upBounds = cms.vdouble(0.85,3.0,50), values = cms.vdouble(0.850527), uncertainties = cms.vdouble(0.119681,0.119681)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,50), upBounds = cms.vdouble(0.85,3.0,60), values = cms.vdouble(0.861851), uncertainties = cms.vdouble(0.123405,0.123405)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,60), upBounds = cms.vdouble(0.85,3.0,70), values = cms.vdouble(0.890836), uncertainties = cms.vdouble(0.223341,0.223341)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,70), upBounds = cms.vdouble(0.85,3.0,90), values = cms.vdouble(0.896951), uncertainties = cms.vdouble(0.140135,0.140135)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,90), upBounds = cms.vdouble(0.85,3.0,999999), values = cms.vdouble(0.900974), uncertainties = cms.vdouble(0.138633,0.138633)),
...
subleadTriggerScaleBins = cms.PSet(
    ...
    bins = cms.VPSet(
        ...
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,0), upBounds = cms.vdouble(0.85,3.0,22.5), values = cms.vdouble(0.787275), uncertainties = cms.vdouble(0.278766,0.278766)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,22.5), upBounds = cms.vdouble(0.85,3.0,25), values = cms.vdouble(0.777265), uncertainties = cms.vdouble(0.171962,0.171962)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,25), upBounds = cms.vdouble(0.85,3.0,27.5), values = cms.vdouble(0.79815), uncertainties = cms.vdouble(0.203152,0.203152)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,27.5), upBounds = cms.vdouble(0.85,3.0,30), values = cms.vdouble(0.811727), uncertainties = cms.vdouble(0.171971,0.171971)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,30), upBounds = cms.vdouble(0.85,3.0,33.3333), values = cms.vdouble(0.816492), uncertainties = cms.vdouble(0.128134,0.128134)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,33.3333), upBounds = cms.vdouble(0.85,3.0,35), values = cms.vdouble(0.829126), uncertainties = cms.vdouble(0.146704,0.146704)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,35), upBounds = cms.vdouble(0.85,3.0,40), values = cms.vdouble(0.839178), uncertainties = cms.vdouble(0.072172,0.072172)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,40), upBounds = cms.vdouble(0.85,3.0,45), values = cms.vdouble(0.850255), uncertainties = cms.vdouble(0.0671414,0.0671414)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,45), upBounds = cms.vdouble(0.85,3.0,50), values = cms.vdouble(0.854513), uncertainties = cms.vdouble(0.0891853,0.0891853)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,50), upBounds = cms.vdouble(0.85,3.0,60), values = cms.vdouble(0.878577), uncertainties = cms.vdouble(0.146525,0.146525)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,60), upBounds = cms.vdouble(0.85,3.0,70), values = cms.vdouble(0.893625), uncertainties = cms.vdouble(0.221853,0.221853)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,70), upBounds = cms.vdouble(0.85,3.0,90), values = cms.vdouble(0.894782), uncertainties = cms.vdouble(0.532653,0.532653)),
        cms.PSet(lowBounds = cms.vdouble(0.8,1.5,90), upBounds = cms.vdouble(0.85,3.0,999999), values = cms.vdouble(0.888978), uncertainties = cms.vdouble(0.142999,0.142999)),
