...
binInfo = cms.PSet(
    ...
    bins = cms.VPSet(
        ...
        cms.PSet( lowBounds = cms.vdouble( -6.0000,  0.0000 ) , upBounds = cms.vdouble( -2.0000, 10.0000 ) , values = cms.vdouble( 1.0000 ) , uncertainties = cms.vdouble( 0.0214 ) ),
        cms.PSet( lowBounds = cms.vdouble( -6.0000, 10.0000 ) , upBounds = cms.vdouble( -2.0000, 20.0000 ) , values = cms.vdouble( 1.0330 ) , uncertainties = cms.vdouble( 0.0214 ) ),
        cms.PSet( lowBounds = cms.vdouble( -6.0000, 20.0000 ) , upBounds = cms.vdouble( -2.0000, 30.0000 ) , values = cms.vdouble( 0.9936 ) , uncertainties = cms.vdouble( 0.0124 ) ),
        cms.PSet( lowBounds = cms.vdouble( -6.0000, 30.0000 ) , upBounds = cms.vdouble( -2.0000, 40.0000 ) , values = cms.vdouble( 1.0093 ) , uncertainties = cms.vdouble( 0.0106 ) ),
        cms.PSet( lowBounds = cms.vdouble( -6.0000, 40.0000 ) , upBounds = cms.vdouble( -2.0000, 50.0000 ) , values = cms.vdouble( 1.0076 ) , uncertainties = cms.vdouble( 0.0068 ) ),
        cms.PSet( lowBounds = cms.vdouble( -6.0000, 50.0000 ) , upBounds = cms.vdouble( -2.0000, 9999999. ) , values = cms.vdouble( 1.0080 ) , uncertainties = cms.vdouble( 0.0115 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( -2.0000, 50.0000 ) , upBounds = cms.vdouble( -1.5660, 9999999. ) , values = cms.vdouble( 0.9921 ) , uncertainties = cms.vdouble( 0.0043 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( -1.5660, 50.0000 ) , upBounds = cms.vdouble( -1.4440, 9999999. ) , values = cms.vdouble( 0.9909 ) , uncertainties = cms.vdouble( 0.0123 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( -1.4440, 50.0000 ) , upBounds = cms.vdouble( -0.8000, 9999999. ) , values = cms.vdouble( 0.9842 ) , uncertainties = cms.vdouble( 0.0021 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( -0.8000, 50.0000 ) , upBounds = cms.vdouble( 0.0000, 9999999. ) , values = cms.vdouble( 0.9764 ) , uncertainties = cms.vdouble( 0.0023 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( 0.0000, 50.0000 ) , upBounds = cms.vdouble( 0.8000, 9999999. ) , values = cms.vdouble( 0.9875 ) , uncertainties = cms.vdouble( 0.0023 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( 0.8000, 50.0000 ) , upBounds = cms.vdouble( 1.4440, 9999999. ) , values = cms.vdouble( 0.9832 ) , uncertainties = cms.vdouble( 0.0021 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( 1.4440, 50.0000 ) , upBounds = cms.vdouble( 1.5660, 9999999. ) , values = cms.vdouble( 0.9728 ) , uncertainties = cms.vdouble( 0.0123 ) ),
        ...
        cms.PSet( lowBounds = cms.vdouble( 1.5660, 50.0000 ) , upBounds = cms.vdouble( 2.0000, 9999999. ) , values = cms.vdouble( 1.0046 ) , uncertainties = cms.vdouble( 0.0043 ) ),
        
        cms.PSet( lowBounds = cms.vdouble( 2.0000,  0.0000 ) , upBounds = cms.vdouble( 6.0000, 10.0000 ) , values = cms.vdouble( 1.0000 ) , uncertainties = cms.vdouble( 0.0214 ) ),
        cms.PSet( lowBounds = cms.vdouble( 2.0000, 10.0000 ) , upBounds = cms.vdouble( 6.0000, 20.0000 ) , values = cms.vdouble( 0.9637 ) , uncertainties = cms.vdouble( 0.0214 ) ),
        cms.PSet( lowBounds = cms.vdouble( 2.0000, 20.0000 ) , upBounds = cms.vdouble( 6.0000, 30.0000 ) , values = cms.vdouble( 0.9723 ) , uncertainties = cms.vdouble( 0.0124 ) ),
        cms.PSet( lowBounds = cms.vdouble( 2.0000, 30.0000 ) , upBounds = cms.vdouble( 6.0000, 40.0000 ) , values = cms.vdouble( 0.9853 ) , uncertainties = cms.vdouble( 0.0106 ) ),
        cms.PSet( lowBounds = cms.vdouble( 2.0000, 40.0000 ) , upBounds = cms.vdouble( 6.0000, 50.0000 ) , values = cms.vdouble( 0.9977 ) , uncertainties = cms.vdouble( 0.0068 ) ),
        cms.PSet( lowBounds = cms.vdouble( 2.0000, 50.0000 ) , upBounds = cms.vdouble( 6.0000, 9999999. ) , values = cms.vdouble( 0.9983 ) , uncertainties = cms.vdouble( 0.0115 ) )
