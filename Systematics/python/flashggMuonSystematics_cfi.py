...
binInfo = cms.PSet(
		...
		bins = cms.VPSet(
			...
			cms.PSet(lowBounds = cms.vdouble(-5.0,100.00), upBounds = cms.vdouble(-2.1,float('inf')), values = cms.vdouble(0.9046), uncertainties = cms.vdouble(0.0799,0.0799)),	
			...
			cms.PSet(lowBounds = cms.vdouble(-2.1,100.00), upBounds = cms.vdouble(-1.6,float('inf')), values = cms.vdouble(1.0057), uncertainties = cms.vdouble(0.0185,0.0185)),	
			...
			cms.PSet(lowBounds = cms.vdouble(-1.6,100.00), upBounds = cms.vdouble(-1.2,float('inf')), values = cms.vdouble(1.0099), uncertainties = cms.vdouble(0.0186,0.0186)),	
			...
			cms.PSet(lowBounds = cms.vdouble(-1.2,100.00), upBounds = cms.vdouble(-1.1,float('inf')), values = cms.vdouble(1.0212), uncertainties = cms.vdouble(0.0279,0.0279)),	
			...
			cms.PSet(lowBounds = cms.vdouble(-1.1,100.00), upBounds = cms.vdouble(-0.9,float('inf')), values = cms.vdouble(1.0186), uncertainties = cms.vdouble(0.0278,0.0278)),	
			...
			cms.PSet(lowBounds = cms.vdouble(-0.9,100.00), upBounds = cms.vdouble(-0.6,float('inf')), values = cms.vdouble(0.9821), uncertainties = cms.vdouble(0.0223,0.0223)),	
			...
			cms.PSet(lowBounds = cms.vdouble(-0.6,100.00), upBounds = cms.vdouble(0,float('inf')), values = cms.vdouble(0.9801), uncertainties = cms.vdouble(0.0223,0.0223)),	
			...
			cms.PSet(lowBounds = cms.vdouble(0.0,100.00), upBounds = cms.vdouble(0.6,float('inf')), values = cms.vdouble(0.9833), uncertainties = cms.vdouble(0.0224,0.0224)),	
			...
			cms.PSet(lowBounds = cms.vdouble(0.6,100.00), upBounds = cms.vdouble(0.9,float('inf')), values = cms.vdouble(0.9853), uncertainties = cms.vdouble(0.0224,0.0224)),	
			...
			cms.PSet(lowBounds = cms.vdouble(0.9,100.00), upBounds = cms.vdouble(1.1,float('inf')), values = cms.vdouble(1.0219), uncertainties = cms.vdouble(0.0279,0.0279)),	
			...
			cms.PSet(lowBounds = cms.vdouble(1.1,100.00), upBounds = cms.vdouble(1.2,float('inf')), values = cms.vdouble(1.0201), uncertainties = cms.vdouble(0.0278,0.0278)),	
			...
			cms.PSet(lowBounds = cms.vdouble(1.2,100.00), upBounds = cms.vdouble(1.6,float('inf')), values = cms.vdouble(1.0089), uncertainties = cms.vdouble(1.0091,0.0186)),	
			...
			cms.PSet(lowBounds = cms.vdouble(1.6,100.00), upBounds = cms.vdouble(2.1,float('inf')), values = cms.vdouble(1.0051), uncertainties = cms.vdouble(0.0185,0.0185)),	
			...
			cms.PSet(lowBounds = cms.vdouble(2.1,100.00), upBounds = cms.vdouble(5.0,float('inf')), values = cms.vdouble(0.8994), uncertainties = cms.vdouble(0.0795,0.0795))	
