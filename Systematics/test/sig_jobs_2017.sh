...
useAAA=0
version="1058"
fggRunJobs.py --load sig_jobs_2017.json -d sig_jobs_$version -x cmsRun workspaceStd.py maxEvents=-1 -n 500 -q $queue -D -P useAAA=$useAAA doHTXS=True doFiducial=False tthTagsOnly=True
