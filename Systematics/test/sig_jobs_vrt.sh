...
fggRunJobs.py --load sig_jobs_vrt_fiducial.json -d sig_jobs_$version -x cmsRun workspaceStd.py maxEvents=1000 -D -P useAAA=$useAAA doFiducial=True  puTarget=$puTarget
