...
fggRunJobs.py -q long.q --load sig_jobs_vrt_IA.json  -d signal_testws_80_fixDataset_IA/ -n 500  -D -P  -x cmsRun workspaceStd_Differential_GenVars_IA_new.py maxEvents=-1