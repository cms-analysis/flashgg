...
fggRunJobs.py -q long.q --load sig_jobs_vrt_OA_new.json  -d signal_testws_80_fixCatalog_OA/ -n 500  -D -P  -x cmsRun workspaceStd_Differential_GenVars_OA_new.py maxEvents=-1