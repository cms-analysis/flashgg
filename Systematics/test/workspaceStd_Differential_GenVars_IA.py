...
matchCut = "leadingPhoton.hasMatchedGenPhoton() && subLeadingPhoton.hasMatchedGenPhoton() && leadingView().phoIdMvaWrtChosenVtx() >0.0367 && subLeadingView().phoIdMvaWrtChosenVtx() >0.0367"
...
#print process.flashggDiPhotonSystematics.scalesAndSmearingsPrefix
#process.scalesAndSmearingsPrefix = cms.string("EgammaAnalysis/ElectronTools/data/Golden10June_plus_DCS")
#print process.scalesAndSmearingsPrefix
...
customize.setDefault("targetLumi",3.66e+3)
