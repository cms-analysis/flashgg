...
#ifndef WORKSPACELINEARCOMBINER
#define WORKSPACELINEARCOMBINER
...
class WorkspaceLinearCombiner
{

public:

    WorkspaceLinearCombiner();

    ~WorkspaceLinearCombiner();

    void Init( string outputFileName_, map<string,float> inputfiles_ );
