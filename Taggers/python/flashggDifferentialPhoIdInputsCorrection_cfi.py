...
def setup_flashggDifferentialPhoIdInputsCorrection( process, metaConditions ):
    ...
    flashggTHQLeptonicTag.thqCatweightfile_ForNonPeakingBkg = cms.FileInPath(str(metaConditions['THQLeptonicTag']['MVAweights']))
    flashggTHQLeptonicTag.MVAThreshold_ForNonPeakingBkg = cms.double(metaConditions['THQLeptonicTag']['MVAThreshold'])
