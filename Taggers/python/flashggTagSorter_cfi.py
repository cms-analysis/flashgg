...
#        cms.PSet(TagName = cms.InputTag('flashggDoubleHTag')), # hint priority for double H tag w/ ttH veto
    #    cms.PSet(TagName = cms.InputTag('flashggHHWWggTag')), # HHWWgg
        ...
        ###                                                                 cms.PSet(TagName = cms.InputTag('flashggSigmaMoMpToMTag'))
                                ...
                                #   MaxObjectWeightException = cms.double(10.),# case for HHWWgg where this killed a job with loose cuts and many scale factors - so just jacking value up below 
                                  MaxObjectWeightException = cms.double(100.),
