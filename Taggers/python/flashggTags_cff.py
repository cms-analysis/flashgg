...
#                                       Boundaries = cms.vdouble( 0.38, 0.48, 0.56 ),
				       Boundaries = cms.vdouble(0.95,0.99,0.996,0.99804), 
...
flashggTTHLeptonicTag = cms.EDProducer("FlashggTTHLeptonicTagProducer",
				       ...
				       tthMVA_RunII_weightfile = cms.FileInPath("flashgg/Taggers/data/ttHLeptonic_RunII_MVA_28May2019.xml"),
                                       leadPhoOverMassThreshold = cms.double(0.0),
                                       subleadPhoOverMassThreshold = cms.double(0.0),
				       MVAThreshold = cms.vdouble(0.93,0.96945995,0.9869719),
