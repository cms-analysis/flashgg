...
#                                              photonIdMVAweightfile_EE = cms.FileInPath("flashgg/MicroAOD/data/MVAweights_80X_25ns_endcap_MoriondVtx.xml"),
                                              ...
                                              correctionFile           = cms.FileInPath("flashgg/MicroAOD/data/transformation_Moriond17_AfterPreApr_v1.root"), ## For Morion17 analysis
                                              ...
                                              doIsoCorrection = cms.bool(True), ## Turn this off to remove stochastic isolation correction
                                              isoCorrectionFile = cms.FileInPath("flashgg/Taggers/data/pho_iso_corrections_hybrid_moriond17_v3.root") ## For Moriond17 analysis
                                              )
