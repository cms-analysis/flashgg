...
void 
SimpleTableOutputBranches::defineBranchesFromFirstEvent(const nanoaod::FlatTable & tab) 
{
    m_baseName=tab.name();
...
void 
SimpleTableOutputBranches::branch(TTree &tree) 
{
    if (!m_singleton)  {
...
void SimpleTableOutputBranches::fill(const edm::Event &iEvent, TTree & tree, bool extensions) 
{
