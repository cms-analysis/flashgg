...
cfgTools.addCategories(process.tthHadronicTagDumper,
			...
			"jet1_udsgdiscriminant  := ?(jetVector.size>0)? jetVector.at(0).bDiscriminator('pfDeepCSVJetTags:probudsg') : -1",
                        ...
                        "jet11_udsgdiscriminant  := ?(jetVector.size>10)? jetVector.at(10).bDiscriminator('pfDeepCSVJetTags:probudsg') : -1",                        "jet12_udsgdiscriminant  := ?(jetVector.size>11)? jetVector.at(11).bDiscriminator('pfDeepCSVJetTags:probudsg') : -1",                        "jet13_udsgdiscriminant  := ?(jetVector.size>12)? jetVector.at(12).bDiscriminator('pfDeepCSVJetTags:probudsg') : -1",                        "jet14_udsgdiscriminant  := ?(jetVector.size>13)? jetVector.at(13).bDiscriminator('pfDeepCSVJetTags:probudsg') : -1",
