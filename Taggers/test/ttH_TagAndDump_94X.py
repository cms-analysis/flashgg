...
cfgTools.addCategories(process.tthHadronicTagDumper,
			...
			"jet1_bdiscriminant  := ?(jetVector.size>0)? jetVector.at(0).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet2_bdiscriminant  := ?(jetVector.size>1)? jetVector.at(1).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet3_bdiscriminant  := ?(jetVector.size>2)? jetVector.at(2).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet4_bdiscriminant  := ?(jetVector.size>3)? jetVector.at(3).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet5_bdiscriminant  := ?(jetVector.size>4)? jetVector.at(4).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet6_bdiscriminant  := ?(jetVector.size>5)? jetVector.at(5).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet7_bdiscriminant  := ?(jetVector.size>6)? jetVector.at(6).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet8_bdiscriminant  := ?(jetVector.size>7)? jetVector.at(7).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet9_bdiscriminant  := ?(jetVector.size>8)? jetVector.at(8).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet10_bdiscriminant  := ?(jetVector.size>9)? jetVector.at(9).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet11_bdiscriminant  := ?(jetVector.size>10)? jetVector.at(10).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet12_bdiscriminant  := ?(jetVector.size>11)? jetVector.at(11).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet13_bdiscriminant  := ?(jetVector.size>12)? jetVector.at(12).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet14_bdiscriminant  := ?(jetVector.size>13)? jetVector.at(13).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",
                        "jet15_bdiscriminant  := ?(jetVector.size>14)? jetVector.at(14).bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -1",			
