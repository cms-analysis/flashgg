...
#process.flashggUpdatedIdMVADiPhotons.correctionFile          = cms.FileInPath("flashgg/MicroAOD/data/transformation_forProbe_15Septdupdatedidmva_noDiPhoMVA_loosepresel_tagchIsoVtx0at2.root")
#process.flashggUpdatedIdMVADiPhotons.correctionFile          = cms.FileInPath("flashgg/MicroAOD/data/transformation_forProbe_15Septdupdatedidmva_noDiPhoMVA_loosepresel_tagprobechIsoVtx0at2.root")
#process.flashggUpdatedIdMVADiPhotons.correctionFile          = cms.FileInPath("flashgg/MicroAOD/data/transformation_forProbe_17Septdupdatedidmva_noDiPhoMVA_loosepresel_tagchIsoVtx0at2_PUcorrect.root")
process.flashggUpdatedIdMVADiPhotons.correctionFile          = cms.FileInPath("flashgg/MicroAOD/data/transformation_forProbe_23SepIdMVA_noDiPhoMVA_loosepresel_tagchIsoVtx0at2.root")
