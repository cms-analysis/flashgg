...
process.flashggUpdatedIdMVADiPhotons.correctionFile          = cms.FileInPath("flashgg/MicroAOD/data/transformation_forProbe_17Septdupdatedidmva_noDiPhoMVA_loosepresel_tagprobechIsoVtx0at2_PUcorrect.root")
