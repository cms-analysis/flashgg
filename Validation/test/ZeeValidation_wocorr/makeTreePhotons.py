...
myoptions['SUBLEADING_PHOTON_CUTS']           = "(abs(superCluster.eta)<2.5) && !(1.4442<=abs(superCluster.eta)<=1.566) && pt > 22."
...
myoptions['LEADING_PRESELECTION']  = """(abs(leadingPhoton.superCluster.eta) < 2.5 && abs(subLeadingPhoton.superCluster.eta) < 2.5) &&
                                        ...
                                        ((leadingPhoton.full5x5_r9 > 0.48 && leadingPhoton.isEB) || (leadingPhoton.full5x5_r9 > 0.77 && leadingPhoton.isEE)) &&
                                        ((subLeadingPhoton.full5x5_r9 > 0.48 && subLeadingPhoton.isEB) || (subLeadingPhoton.full5x5_r9 > 0.77 && subLeadingPhoton.isEE)) &&
                                        ((leadingPhoton.isEB && 
                                        (leadingPhoton.full5x5_r9>0.85 ||
                                        (leadingPhoton.full5x5_sigmaIetaIeta < 0.0175 && leadingPhoton.pfPhoIso03 < 4.0 && leadingPhoton.trkSumPtHollowConeDR03 < 6.0 ))) ||
                                        (leadingPhoton.isEE && 
                                        (leadingPhoton.full5x5_r9>0.9 ||
                                        (leadingPhoton.full5x5_sigmaIetaIeta < 0.037 && leadingPhoton.pfPhoIso03 < 4.0 && leadingPhoton.trkSumPtHollowConeDR03 < 6.0 )))) &&
...
myoptions['SUBLEADING_PRESELECTION'] = """(abs(leadingPhoton.superCluster.eta) < 2.5 && abs(subLeadingPhoton.superCluster.eta) < 2.5) &&
                                          (subLeadingPhoton.pt > 22.) && (subLeadingPhoton.hadronicOverEm < 0.08) &&
                                          ((leadingPhoton.full5x5_r9 > 0.48 && leadingPhoton.isEB) || (leadingPhoton.full5x5_r9 > 0.77 && leadingPhoton.isEE)) &&
                                          ((subLeadingPhoton.full5x5_r9 > 0.48 && subLeadingPhoton.isEB) || (subLeadingPhoton.full5x5_r9 > 0.77 && subLeadingPhoton.isEE)) &&
                                          (( subLeadingPhoton.isEB && 
                                          (subLeadingPhoton.full5x5_r9>0.85 ||
                                          (subLeadingPhoton.full5x5_sigmaIetaIeta < 0.0175 && subLeadingPhoton.pfPhoIso03 < 4.0 && subLeadingPhoton.trkSumPtHollowConeDR03 < 6.0 ))) ||
                                          (subLeadingPhoton.isEE && 
                                          (subLeadingPhoton.full5x5_r9>0.9 ||
                                          (subLeadingPhoton.full5x5_sigmaIetaIeta < 0.037 && subLeadingPhoton.pfPhoIso03 < 6.0 && subLeadingPhoton.trkSumPtHollowConeDR03 < 6.0 )))) &&
...
if (isMC):
    ...
    myoptions['INPUT_FILE_NAME']       = (
        #"/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIIFall17-3_0_1/3_0_1/SingleElectron/RunIIFall17-3_0_1-3_0_1-v0-Run2017F-17Nov2017-v1/180331_075844/0000/myMicroAODOutputFile_1.root"
        "/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIIFall17-3_1_0/3_1_0/SingleElectron/RunIIFall17-3_1_0-3_1_0-v0-Run2017E-31Mar2018-v1/180606_163402/0000/myMicroAODOutputFile_775.root",
        "/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIIFall17-3_1_0/3_1_0/SingleElectron/RunIIFall17-3_1_0-3_1_0-v0-Run2017E-31Mar2018-v1/180606_163402/0000/myMicroAODOutputFile_61.root",
        "/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIIFall17-3_1_0/3_1_0/SingleElectron/RunIIFall17-3_1_0-3_1_0-v0-Run2017E-31Mar2018-v1/180606_163402/0001/myMicroAODOutputFile_1111.root",
        "/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIIFall17-3_1_0/3_1_0/SingleElectron/RunIIFall17-3_1_0-3_1_0-v0-Run2017E-31Mar2018-v1/180606_163402/0000/myMicroAODOutputFile_751.root",
        "/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIIFall17-3_1_0/3_1_0/SingleElectron/RunIIFall17-3_1_0-3_1_0-v0-Run2017E-31Mar2018-v1/180606_163402/0001/myMicroAODOutputFile_1331.root"
        )
...
#process.flashggUpdatedIdMVADiPhotons.correctionFile          = cms.FileInPath("flashgg/MicroAOD/data/transformation5x5_ReReco2017_v3.root")
...
if ("data" in customize.processId or not isMC):
    print 'data'
