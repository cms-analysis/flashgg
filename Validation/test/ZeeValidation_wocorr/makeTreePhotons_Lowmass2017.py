...
# for applying showershape corrections
doShowershape = False
#doShowershape = True
...
myoptions['PHOTON_TAG_CUTS']       = """(abs(superCluster.eta)<=2.1) && !(1.4442<=abs(superCluster.eta)<=1.566) && pt > 35. && full5x5_r9 > 0.8 && pfChgIso03WrtVtx0 < 20.0 && (pfChgIso03WrtVtx0/pt)<=0.3
"""
...
# 2017 Low preselection for leading and subleading photons pt > 30 (lead) & pt > 18 (sublead)
...
if (isMC):
    ...
    myoptions['INPUT_FILE_NAME']       = ("/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIIFall17-3_0_0/3_0_0/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17-3_0_0-3_0_0-v0-RunIIFall17MiniAOD-94X_mc2017_realistic_v10-v1/180327_095800/0000/myMicroAODOutputFile_106.root")
    ...
    myoptions['TnPHLTProbeFilters']    = cms.vstring()
    myoptions['HLTFILTERTOMEASURE']    = cms.vstring("")
    #myoptions['GLOBALTAG']             = '94X_dataRun2_ReReco_EOY17_v2'  # RunIIFall17_2_7_7
    myoptions['GLOBALTAG']             = '94X_dataRun2_ReReco17_forValidation'  # RunIIFall17_3_0_0
    myoptions['EVENTSToPROCESS']       = cms.untracked.VEventRange()
