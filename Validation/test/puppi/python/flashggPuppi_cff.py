...
flashggPuppiCentral = cms.VPSet(
                 cms.PSet(
                  algoId           = cms.int32(5),  #0 is default FlashggPuppi
...
flashggPuppi = cms.EDProducer("flashggPuppiProducer",#cms.PSet(#"flashggPuppiProducer",
                       ...
                       #vertexName     = cms.string('offlineSlimmedPrimaryVertices'),
                              ...
                              algos          = cms.VPSet( 
                                  cms.PSet( 
                                      ...
                                      puppiAlgos = flashggPuppiCentral
                                  ),
                                  cms.PSet( 
                         ...
                         # MedEtaSF = cms.double(0.845),
                                      ...
                                      EtaMaxExtrap = cms.double(2.0),
                                      puppiAlgos = flashggPuppiForward
                                  ),
                                  cms.PSet( 
